...
public class DBApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String creteTable = "CREATE TABLE Student3 (id INT PRIMARY KEY,name VARCHAR,gpa double);";
            String createIndex = "CREATE INDEX gpaIndex ON Student3(gpa)";
            String insert = "INSERT INTO Student (id,name,gpa) VALUES (10,'Ahd',0.7);";
            String delete = "DELETE FROM Student3 WHERE gpa = 3;";
            String update = "UPDATE Student SET gpa=4 WHERE id = 5;";
            String select = "SELECT * FROM Student3 WHERE gpa = 0;";
...
//            for(;id<1200;id++){
//                String sql = "INSERT INTO Student3 (id,name,gpa) VALUES ("+id+","+name+id+","+id%4+");";
//                StringBuffer stringBuffer = new StringBuffer();
//                stringBuffer.append(sql);
//                dbApp.parseSQL(stringBuffer);
//            }
//            long endTime = System.currentTimeMillis()/1000;
//            System.out.println("End Time: " + endTime);
//            dbApp.parseSQL(stringBuffer2);

            // track the time before the operation
            long startTime = System.currentTimeMillis()/1000;
            System.out.println("Start Time: " + startTime);
             dbApp.parseSQL(stringBuffer5);
//            while (saosan.hasNext()) {
//                System.out.println(saosan.next());
//            }
            // track the time after the operation
            long endTime = System.currentTimeMillis()/1000;
            System.out.println("End Time: " + endTime);
            System.out.println("total time: " + (endTime-startTime));
//            long startTime = System.currentTimeMillis()/1000;
//            for(;id<405;id++){
//                String sql = "Delete from Student3 where id = "+id+";";
//                StringBuffer stringBuffer = new StringBuffer();
//                stringBuffer.append(sql);
//                dbApp.parseSQL(stringBuffer);
//            }
...
//            Table table = Table.deserialize("Student3");
//            System.out.println(table.getPagesAddresses().size());
    ...
    public Iterator parseSQL(StringBuffer strbufSQL) throws DBAppException {
        try {
            ...
            if (GUI.dbApp != null) {
                GUI.textArea.setStyle(GUI.redStyle);
                if (e.getMessage().contains("antlr")) GUI.textArea.appendText("\nError: Sql Syntax Error");
                else GUI.textArea.appendText("\nError: " + e.getMessage());
            }
        }
        return null;
    }
